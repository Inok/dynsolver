...
namespace DynamicSolver.Modelling.Tests.Experiments
{
    ...
    public class ModellingMethodExperiments
    {
        ...
        public void ModellingTime()
        {
            ...
            {
/*
                new ExtrapolationSolver(new ExplicitEulerSolver(), 2),
                ...
                new ExtrapolationSolver(new KDFirstExplicitDynamicSystemSolver(), 8),

                new SymmetricExplicitMiddlePointExtrapolationSolver(2),
                new SymmetricExplicitMiddlePointExtrapolationSolver(4),
                new SymmetricExplicitMiddlePointExtrapolationSolver(8),
