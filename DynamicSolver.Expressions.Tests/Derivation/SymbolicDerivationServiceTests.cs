...
namespace DynamicSolver.Expressions.Tests.Derivation
{
    [TestFixture]
    public class SymbolicDerivationServiceTests
    {
        private readonly Expressions.Parser.ExpressionParser _parser = new Expressions.Parser.ExpressionParser();
